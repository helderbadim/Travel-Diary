...
<?php foreach ($results as $result): ?>
    <div class="card">
        ...
        <div class="card__desc-container">
            ...
            <p class="card__paragraph"><?php echo nl2br(e($result['message'])) ?>
            </p>
        </div>
    </div>
<?php endforeach; ?>
<?php if ($numPages > 1): ?>
    <ul class="pagination">
        <?php if ($page > 1): ?>
            <li class="pagination__li"><a class="pagination__link"
                                          href="index.php?<?php echo http_build_query(['page' => $page - 1]) ?>">🡐</a>
            </li>
        <?php endif; ?>
        <?php for ($i = 1; $i <= $numPages; $i++): ?>
            <li class="pagination__li"><a
                        class="pagination__link <?php if ($page === $i): ?> pagination__li--active <?php endif; ?>"
                        href="index.php?<?php echo http_build_query(['page' => $i]) ?>"><?php echo e($i) ?></a>
            </li>
        <?php endfor; ?>
